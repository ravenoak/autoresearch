...
from autoresearch.a2a_interface import (
    A2AInterface, A2AClient, get_a2a_client, requires_a2a, A2A_AVAILABLE
)
...
class TestA2AInterface:
    ...
    def test_handle_query(self, mock_a2a_server, mock_a2a_message, mock_orchestrator):
        ...
        mock_orchestrator.run_query.return_value.to_dict.return_value = {"answer": "test answer"}
    ...
    def test_handle_command_get_capabilities(self, mock_a2a_server, mock_a2a_message):
        ...
        interface._handle_get_capabilities = MagicMock(return_value={"capabilities": "test"})
    ...
    def test_handle_command_unknown(self, mock_a2a_server, mock_a2a_message):
        ...
        # Verify
        assert result == {"status": "error", "error": "Unknown command: unknown_command"}
...
class TestA2AClient:
    ...
    def test_init(self):
        ...
        with patch("autoresearch.a2a_interface.A2AClient.__init__", return_value=None) as mock_init:
            client = A2AClient()
    ...
    def test_query_agent(self, mock_a2a_client):
        ...
        # Setup
        with patch("autoresearch.a2a_interface.A2AClient", return_value=mock_a2a_client):
            client = A2AClient()
            mock_a2a_client.send_message.return_value = {"status": "success", "result": {"answer": "test answer"}}
    ...
    def test_get_agent_capabilities(self, mock_a2a_client):
        ...
        with patch("autoresearch.a2a_interface.A2AClient", return_value=mock_a2a_client):
            client = A2AClient()
            mock_a2a_client.send_message.return_value = {"status": "success", "result": {"capabilities": "test"}}
    ...
    def test_get_agent_config(self, mock_a2a_client):
        ...
        with patch("autoresearch.a2a_interface.A2AClient", return_value=mock_a2a_client):
            client = A2AClient()
            mock_a2a_client.send_message.return_value = {"status": "success", "result": {"config": "test"}}
    ...
    def test_set_agent_config(self, mock_a2a_client):
        ...
        with patch("autoresearch.a2a_interface.A2AClient", return_value=mock_a2a_client):
            client = A2AClient()
            mock_a2a_client.send_message.return_value = {"status": "success", "result": {"updated": True}}
