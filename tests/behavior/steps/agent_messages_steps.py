...
def test_agent_message_exchange() -> None:
    """Scenario placeholder generated by pytest-bdd."""
...
def receiver_got_message(response: QueryResponse) -> None:
    metrics: dict[str, Any] = response.metrics
...
def receivers_got_broadcast(response: QueryResponse) -> None:
    metrics: dict[str, Any] = response.metrics
    msgs_r1: dict[str, Any] = metrics["delivered_messages"]["R1"][0]
    msgs_r2: dict[str, Any] = metrics["delivered_messages"]["R2"][0]
