...
def main():
    ...
    parser.add_argument("--extensions", default="vector", help="Comma-separated list of extensions to download")
    ...
    if success:
        ...
        logger.info("\n[storage.duckdb]")
        logger.info(f"vector_extension_path = \"{os.path.join(output_dir, 'extensions', 'vector')}\"")
    else:
