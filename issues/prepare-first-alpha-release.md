...
As of **October 10, 2025 at 14:44 UTC** `task release:alpha` now syncs only the
...
is set.【F:Taskfile.yml†L457-L520】【F:docs/releasing.md†L20-L28】【F:docs/release_plan.md†L114-L122】
